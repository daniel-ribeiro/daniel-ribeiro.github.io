// ORIGINAL INSTRUCTIONS (LINE 20)
  // There should really be some JSON-formatted data in movies.json, instead of an empty array.  -- DONE!!
  ...
  // sqlite3 -csv -header movies.sqlite3 'select "imdbID" as id, "title" from movies' | csvtojson --maxRowLength=0 > movies.json (OK DIFFERENT)

//ORIGINAL INSTRUCTIONS (LINE 57)
...
//ORIGINAL INSTRUCTIONS (LINE 115)
...
var base = Rebase.createClass({
  apiKey: "AIzaSyCw98ELui-Gyw0wtv-ihPkG7EVf43sM13o",   // replace with your Firebase application's API key - OKKK
  databaseURL: "https://buyflix-50f4a.firebaseio.com/", // replace with your Firebase application's database URL - OKKK
})
